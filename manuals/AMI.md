...
`Backchannel`と異なり，発言者が主導権を握る（握り続ける）意図があるため，対話相手が発言を継続できないことが多い．話す機会を奪うための無意識での発言である．
...
1. `Correction`: 対話相手の発言の間違いを認識してより正確な情報を提供する．発言者は訂正のため，対話相手の発言に同意しないか否定することが一般的である．表明された非同意・否定の強度は問わない．
    ```
    A) 猫ほどかわいい生き物はいないのだと。
...
上記サブカテゴリに該当しない場合は，サブカテゴリを省略しラベリングすること．
